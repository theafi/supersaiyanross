...
<html>
        ...
        function checkCountry(s)
    {
        ...
        ?>
        <div class="registro">
            <form enctype="multipart/form-data" onSubmit="return checkPass(this);" action="registro1.php" autocomplete="on" method="post" >
            <div class="form-group">
                    ...
                    <select class="form-select" autocomplete="pais" id="pais" name="pais">
